...
public class QuizBucket {
	...
	public String toString() {
		return "QuizBucket [question=" + question + ", selection=" + selection + ", questionNumber=" + questionNumber
				+ ", answer=" + answer + ", explanation=" + explanation + ", questionType=" + questionType
				+ ", memberAnswer=" + memberAnswer + ", correct=" + correct + ", memberNumber=" + memberNumber
				+ ", sessionId=" + sessionId + ", status=" + status + ", questionsMap=" + questionsMap + ", answersMap="
				+ answersMap + "]";
	}
